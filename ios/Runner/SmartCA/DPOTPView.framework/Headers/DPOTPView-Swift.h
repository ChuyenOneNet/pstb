...
#ifndef DPOTPVIEW_SWIFT_H
#define DPOTPVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DPOTPView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9DPOTPView9DPOTPView")
...
@interface DPOTPView (SWIFT_EXTENSION(DPOTPView)) <UITextFieldDelegate>
