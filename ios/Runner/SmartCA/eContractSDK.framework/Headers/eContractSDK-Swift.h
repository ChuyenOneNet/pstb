...
// Generated by Apple Swift version 6.0.3 effective-4.2 (swiftlang-6.0.3.1.10 clang-1600.0.30.1)
#ifndef ECONTRACTSDK_SWIFT_H
#define ECONTRACTSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="eContractSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC12eContractSDK19ACFloatingTextfield")
@interface ACFloatingTextfield : UITextField
@property (nonatomic) IBInspectable BOOL isCustomize;
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull placeHolderColor_ACFloatTextField;
/// Change placeholder color while editing.
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull selectedplaceHolderColor_ACFloatTextField;
...
SWIFT_CLASS("_TtC12eContractSDK18BaseViewController")
...
SWIFT_CLASS("_TtC12eContractSDK17DropDownTextField")
@interface DropDownTextField : ACFloatingTextfield
@property (nonatomic, copy) NSString * _Nullable text;
...
@interface DropDownTextField (SWIFT_EXTENSION(eContractSDK)) <UITextFieldDelegate>
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC12eContractSDK13ISRadioButton")
@interface ISRadioButton : UIButton
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull indicatorColor;
...
@property (nonatomic) IBInspectable BOOL multipleSelectionEnabled;
...
SWIFT_CLASS("_TtC12eContractSDK17SelectorTextField")
@interface SelectorTextField : ACFloatingTextfield
@property (nonatomic, copy) NSString * _Nullable text;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (CGRect)textRectForBounds:(CGRect)bounds SWIFT_WARN_UNUSED_RESULT;
...
@interface SelectorTextField (SWIFT_EXTENSION(eContractSDK)) <UITextFieldDelegate>
- (BOOL)textFieldShouldBeginEditing:(UITextField * _Nonnull)textField SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC12eContractSDK29ThongTinHopDongViewController")
@interface ThongTinHopDongViewController : BaseViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface ThongTinHopDongViewController (SWIFT_EXTENSION(eContractSDK)) <NSURLSessionDownloadDelegate>
...
@interface UINavigationController (SWIFT_EXTENSION(eContractSDK))
@property (nonatomic, readonly) UIInterfaceOrientationMask supportedInterfaceOrientations;
@end
